    ...
    <div class="min-h-screen bg-neutral-900">
        ...
        <div class="bg-gradient-to-r from-red-900 to-neutral-900 py-12">
            <div class="container mx-auto px-4">
                <h2 class="text-5xl font-bold text-white text-center mb-4">Gestión de Películas</h2>
                <p class="text-xl text-gray-300 text-center">Administra el catálogo de películas de tu cine</p>
            </div>
        </div>
            ...
            <div class="max-w-4xl mx-auto bg-neutral-800 rounded-xl shadow-xl p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-2">ID de Película</label>
                    ...
                    <!-- Actores y Sinopsis -->
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Actores</label>
                        <input v-model="actors" type="text"
                            class="w-full px-4 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-2">Sinopsis</label>
                        <textarea v-model="sinopsis" rows="3"
                            class="w-full px-4 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"></textarea>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Fecha de Estreno</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-2">Clasificación</label>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="bg-neutral-800 rounded-xl shadow-xl overflow-hidden">
                <h3 class="text-2xl font-bold text-white p-6 border-b border-neutral-700">Lista de Películas</h3>
                    ...
                    <table class="w-full">
                        <thead class="bg-neutral-700">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Director</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Actores</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Sinopsis</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Duración</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Estreno</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Género</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Clasificación</th>
                            </tr>
                        </thead>
                        <tbody class="bg-neutral-800 divide-y divide-neutral-700">
                            <tr v-for="movie in movies" :key="movie.id_movie" @click="editarMovie(movie)"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.id_movie }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.title }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.director }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.actors }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.sinopsis }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.duration }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.premiere }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.genre }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ movie.classification }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
